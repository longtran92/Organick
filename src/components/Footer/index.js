      ...
      <div className="container-wrapper">
        <div className="main-content">
          <div className="contact-us">
            ...
            <div className="contact-method">
              <h6 className="method-heading">Email</h6>
              <span className="method-content">needhelp@Organia.com</span>
            </div>
            <div className="contact-method">
              <h6 className="method-heading">Phone</h6>
              <span className="method-content">666 888 888</span>
            </div>
            <div className="contact-method">
              <h6 className="method-heading">Address</h6>
          ...
          <div className="utility-pages">
            <h3 className="utility-heading">Utility Pages</h3>
        ...
        <div className="footer-trademark">
          <div className="copy-right">
            Copyright © <span className="highlight">Organick</span> | Designed
            by <span className="highlight">VictorFlow</span> Templates - Powered
            by <span className="highlight">Webflow</span>
          </div>
        </div>
      </div>
    </footer>
